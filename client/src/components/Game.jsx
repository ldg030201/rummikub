...
// 값을 세 번 잡는다: ① 즉시 1회(옵저버 초기 콜백이 늦거나 안 오는 컨텍스트 대비)
// ② 다음 프레임(테마 전환 직후처럼 CSS가 아직 반영되기 전일 수 있어서)
// ③ 이후 ResizeObserver 콜백마다. compute는 폭이 0이면 넉넉한 기본값을 돌려주므로
// 레이아웃 확정 전 측정이 잘못 굳지 않는다.
